...
locals {
  health_check_prompt     = file("${path.root}/prompts/health_check.md")
  resource_check_prompt   = file("${path.root}/prompts/resource_check.md")
  cleanup_prompt          = file("${path.root}/prompts/cleanup.md")
  network_check_prompt    = file("${path.root}/prompts/network_check.md")
  security_check_prompt   = file("${path.root}/prompts/security_check.md")
  backup_check_prompt     = file("${path.root}/prompts/backup_check.md")
  cost_analysis_prompt    = file("${path.root}/prompts/cost_analysis.md")
  compliance_check_prompt = file("${path.root}/prompts/compliance_check.md")
  update_check_prompt     = file("${path.root}/prompts/update_check.md")
  capacity_check_prompt   = file("${path.root}/prompts/capacity_check.md")
